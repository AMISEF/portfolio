...
- تیکر متحرک شاخص‌های کلان شامل دامیننس BTC/ETH/تتر (CoinMarketCap)
- نقشهٔ حرارتی دسته‌بندی‌شدهٔ بازار، بدون استیبل‌کوین (Toobit)
- شاخص ترس و طمع به‌صورت گیج گرافیکی (CoinMarketCap؛ پشتیبان alternative.me)
- شاخص فصل آلت‌کوین (Altcoin Season) و دامیننس BTC/ETH/سایر (CoinMarketCap)
- جریان خالص ETFهای کریپتو — نمودار ستونی BTC+ETH (Farside Investors)
- ۵ ارز برتر بازار با آیکون و تغییر ۲۴ساعته، زنده هر ۵ ثانیه (Toobit)
- قیمت‌های کلیدی: تتر تومانی (Tabdeal، **بدون تبدیل**)، طلای ۱۸ عیار و دلار آزاد
  (SourceArena، هر ۱۵ دقیقه)، انس طلا/نقره و نفت خام = XAU/XAG/OIL با تغییر
  واقعی ۲۴ساعته (Yahoo Finance)
- نمودار جریان خالص ETFها با تولتیپ تعاملی (Bitcoin/Ethereum/Total هنگام hover)
