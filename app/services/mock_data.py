...
def toobit_top_coins() -> dict:
    ...
    rows = [
        ...
        ("ADA", "ADAUSDT", 0.62, 1.10, 60_000_000),
        ("DOGE", "DOGEUSDT", 0.16, 1.20, 70_000_000),
        ("TRX", "TRXUSDT", 0.27, 0.05, 40_000_000),
        ("AVAX", "AVAXUSDT", 28.4, -1.20, 35_000_000),
        ("LINK", "LINKUSDT", 17.8, 2.40, 45_000_000),
        ("DOT", "DOTUSDT", 4.2, 0.40, 25_000_000),
        ("LTC", "LTCUSDT", 84.0, -0.60, 30_000_000),
    ]
    return {
        "source": "sample",
        "coins": [
